...
isEmpty(BOOST_LIB_SUFFIX) {
    ...
    android:BOOST_LIB_SUFFIX = -gcc-mt
}
...
isEmpty(BDB_LIB_PATH) {
    ...
    android:BDB_LIB_PATH = /opt/local/lib/db48
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    android:BDB_INCLUDE_PATH = /opt/local/include/db48
}
